...
//@Disabled
public class TeleOp_Ramp_Up_Ramp_Down extends OpMode
{
    ...
    public void loop() {
        ...
        LFPower = Range.clip(-xValue + yValue + strafeValue,-1,1);
        LBPower = Range.clip(-xValue + yValue - strafeValue,-1,1);
        RBPower = Range.clip(-xValue - yValue + strafeValue,-1,1);
        RFPower = Range.clip(-xValue - yValue - strafeValue,-1,1);
